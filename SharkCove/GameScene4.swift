...
class GameScene4: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let lvlindicator = SKSpriteNode(imageNamed: "thereallvl4btn")
    ...
    func loadLevel() {
        if let levelPath = NSBundle.mainBundle().pathForResource("level4", ofType: "txt") {
        ...
        if node.name == "shark" {
            ...
            if (bomb2 >= 1) {
                ...
                player.runAction(sequence) { [unowned self] in
                    ...
                    let nextScene = GameOverScene4(size: self.scene!.size)
            ...
            func updatedefaults () {
                ...
                let defaults = NSUserDefaults.standardUserDefaults()
                defaults.setInteger(1, forKey: "comp5")
                defaults.setInteger(bomb1, forKey: "bombs")
                
                let this = defaults.integerForKey("comp5")
            ...
            player.runAction(sequence) { [unowned self] in
                ...
                let nextScene = SuccessScene4(size: self.scene!.size)
                nextScene.scaleMode = SKSceneScaleMode.AspectFill
