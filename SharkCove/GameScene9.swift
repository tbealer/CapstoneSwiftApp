...
class GameScene9: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let lvlindicator = SKSpriteNode(imageNamed: "thereallvl9btn")
    ...
    func loadLevel() {
        if let levelPath = NSBundle.mainBundle().pathForResource("level9", ofType: "txt") {
        ...
        if node.name == "shark" {
            ...
            if (bomb2 >= 1) {
                ...
                player.runAction(sequence) { [unowned self] in
                    ...
                    let nextScene = GameOverScene9(size: self.scene!.size)
            ...
            func updatedefaults () {
                ...
                let defaults = NSUserDefaults.standardUserDefaults()
                defaults.setInteger(1, forKey: "comp10")
                defaults.setInteger(bomb1, forKey: "bombs")
                
                let this = defaults.integerForKey("comp10")
            ...
            player.runAction(sequence) { [unowned self] in
                ...
                let nextScene = SuccessScene9(size: self.scene!.size)
                nextScene.scaleMode = SKSceneScaleMode.AspectFill
