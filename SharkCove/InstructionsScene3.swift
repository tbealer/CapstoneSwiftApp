...
class InstructionsScene3: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let background = SKSpriteNode(imageNamed: "tryinstruct3")
        ...
        if let touch:UITouch = touches.first {
            ...
            if let name = touchedNode.name
            {
                if name == "next"
                {
                    ...
                    let nextScene = InstructionScene4(size: self.scene!.size)
